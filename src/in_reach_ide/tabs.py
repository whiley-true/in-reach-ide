...
class TabPane(QTabWidget):
    ...
    def open_file(self, path: Path) -> None:
        ...
        # output and *.generated.json snapshots are overwritten wholesale on every successful
        # build, so an edit made here would just silently vanish rather than doing anything.
        editor.setReadOnly(is_generated_file(path))
