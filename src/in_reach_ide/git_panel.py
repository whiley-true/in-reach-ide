...
class GitPanel(QWidget):
    ...
    def __init__(self, parent: QWidget | None = None) -> None:
        ...
        # Each list is its own collapsible sub-section, its Stage All/Unstage All on the heading's line.
        ...
        self.staged_section = CollapsibleSection("Staged Changes (0)", self.staged_list, collapsed=False)
        self.staged_section.add_header_widget(self.unstage_all_button)
        changes_layout.addWidget(self.staged_section)
        ...
        self.unstaged_section = CollapsibleSection("Changes (0)", self.changes_list, collapsed=False)
        self.unstaged_section.add_header_widget(self.stage_all_button)
        changes_layout.addWidget(self.unstaged_section)
    ...
    def refresh(self) -> None:
        ...
        self.staged_section.set_title(f"Staged Changes ({len(staged)})")
        self.unstaged_section.set_title(f"Changes ({len(unstaged)})")
